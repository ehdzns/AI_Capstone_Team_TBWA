...
st.sidebar.markdown("""
    <div style="display: flex; justify-content: space-between;">
        <a href="https://comment-generate-dashboard-how-to-use.streamlit.app/" style="color: #666666; text-decoration: none; font-size: 12px;">❓How to use</a>
        <a href="https://comment-generate-dashboard-developers.streamlit.app/" style="color: #666666; text-decoration: none; font-size: 12px;">💁‍♀️Developers</a>
    </div>
""", unsafe_allow_html=True)
...
with comment_container:
    ...
    if api_input:  # API 키 입력 시
        ...
        try:
            llm = ChatOpenAI(temperature=1.15, top_p= 0.9, model_name='gpt-4')
            api_valid = True
